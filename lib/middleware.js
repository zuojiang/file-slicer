    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            return _context.abrupt('return', _path2.default.join(tmpDir, id, name));
...
var checkFile = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(filePath, override) {
    var existed;
  ...
  return function checkFile(_x2, _x3) {
    ...
    busboy.on('file', function (fieldname, file, filename, encoding, mimetype) {
      var run = function () {
        var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
          var name, filePath, stream, size, _rangeParser, _rangeParser2, _rangeParser2$, start, end;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 8:
                  ...
                  _context3.next = 11;
                  return returnAbsPath({ req: req, res: res, id: id, name: name, tmpDir: tmpDir });
                ...
                case 11:
                  ...
                  _context3.next = 15;
                  return checkFile(filePath, override);
